    ...
    return (
        <section id="experience" className="bg-background">
            <div className="container mx-auto flex flex-col items-center justify-center">
                ...
                <div className="grid grid-cols-1 gap-12 items-center mb-20 rounded-lg">
                    {experiences.map((exp) => (
                        <div key={exp.id} className="grid grid-cols-1 md:grid-cols-[200px,12fr] mx-12 bg-white rounded-lg p-8 gap-2">
